...
<body onload="">
    ...
    <form id="frmCliente" method="post" action="" class="clsUIAgregar">
        <fieldset>
            <div id="divFrmHead">NUEVO CLIENTE</div>
            <div id="divFrmBody">
                <dl>
                    <dt><label>CIFNIF:</label></dt>
                    <dd><input type="text" id="txtCifnif" name="txtCifnif" value="<?php echo $oCliente->getCifnif(); ?>" /></dd>
                    <dt><label>EMPRESA:</label></dt>
                    <dd><input type="text" id="txtEmpresa" name="txtEmpresa" value="<?php echo $oCliente->getEmpresa(); ?>"/></dd>
                    <dt><label>COD.&nbsp;POSTAL:</label></dt>
                    <dd><input type="text" id="txtCodpos" name="txtCodpos" value="<?php echo $oCliente->getCodigoPostal(); ?>" /></dd>
                    <dt><label>CIUDAD:</label></dt>
                    <dd><input type="text" id="txtCiudad" name="txtCiudad" value="<?php echo $oCliente->getCiudad(); ?>" /></dd>
                    <dt><label>DIRECCION:</label></dt>
                    <dd><input type="text" id="txtDirecc" name="txtDirecc" value="<?php echo $oCliente->getDireccion(); ?>" /></dd>
                    <dt><label>TELEFONO/S:</label></dt>
                    <dd><input type="text" id="txtTelefo" name="txtTelefo" value="<?php echo $oCliente->getTelefonos(); ?>" /></dd>
                    <dt><label>MOVIL/ES:</label></dt>
                    <dd><input type="text" id="txtMovil" name="txtMovil" value="<?php echo $oCliente->getMoviles(); ?>" /></dd>
                    <dt><label>P.&nbsp;CONTACTO:</label></dt>
                    <dd><input type="text" id="txtPersona" name="txtPersona" value="<?php echo $oCliente->getPersonaContacto(); ?>" /></dd>
                    <dt><label>EMAIL:</label></dt>
                    <dd><input type="text" id="txtEmail" name="txtEmail" value="<?php echo $oCliente->getEmail(); ?>" /></dd>
                    <dt><label>C.&nbsp;BANCARIA:</label></dt>
                    <dd><input type="text" id="txtCuentaB" name="txtCuentaB" value="<?php echo $oCliente->getCuentaBancaria(); ?>" /></dd>
                </dl>
