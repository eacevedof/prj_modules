...
<body onload="pSeleccionaRadio('<?php echo $oUsuario->getSexo(); ?>','radSexo');">
    <center>
    <div id="divMensaje"><?php echo $sWarning; ?></div>
    
    <!-- EL FORMULARO MODIFICAR -->
    <form id="frmUsuario" method="post" action="" class="clsUIModificar">
        <fieldset>
            <div id="divFrmHead">MODIFICAR DATOS DE USUARIO</div>
            <div id="divFrmBody">
                <dl>
                    ...
                    <dd><input type="radio" id="radSexo" name="radSexo" value="H" />Hombre
